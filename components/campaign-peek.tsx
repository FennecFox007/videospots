    ...
    <SidePanel
      ...
      subtitle={
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {/* Campaign-level approval pill removed in Phase 2c — approval
              now lives on the spot, not the campaign. The per-country spot
              statuses are rendered in the Videos block below; this header
              just shows the campaign's run-state + communication intent. */}
          {c.client && (
      ...
      footer={
        <>
          ...
          {/* Phase 2c: campaign-level "Schvaluji" buttons removed —
              schvalování probíhá teď výhradně na úrovni spotu (Sony klient
              schvaluje per-země kreativu). Přesunuto na /spots/[id]
              status stepper. */}
          <form
            action={async () => {
